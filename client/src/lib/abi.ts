    ...
    outputs: [
      {
        components: [
          ...
          {
            internalType: "enum UniversityDiploma.ProgressionStatus",
            name: "status",
            type: "uint8",
          },
          {
        ...
        internalType: "struct UniversityDiploma.StudentResult",
        name: "r",
        type: "tuple",
      },
    ],
